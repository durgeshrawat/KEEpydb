...
setup(
  ...
  download_url = 'https://github.com/durgeshrawat/KEEpydb/archive/refs/tags/v_02.tar.gz'    # I explain this later on
  ...
  classifiers=[
    ...
    'Topic :: Software Development and database :: Build Tools',
